...
def plot_matches(image1, image2, keypoints1, keypoints2, matches,liners = '',
                 keypoints_color='r', matches_color=None, plot_matche_points=True, matchline = True, matchlinewidth = 0.1,market='.',marketsize=1,
    ...
    if plot_matche_points:
        ...
        plt.scatter(keypoints2[:, 0] + offset[1], keypoints2[:, 1] + offset[0],
                   facecolors='none', edgecolors='r', marker = '.')

    plt.imshow(image, interpolation='nearest', cmap='gray')
    plt.axis((0, image1.shape[1] + offset[1], image1.shape[0] + offset[0], 0))
    ...
    if matchline == True:
        for i in range(matches.shape[0]):
            ...
            plt.plot((keypoints1[idx1, 0], keypoints2[idx2, 0] + offset[1]),
                    (keypoints1[idx1, 1], keypoints2[idx2, 1] + offset[0]),
                     linestyle=liners,color='y',marker=market, markersize=marketsize,linewidth=matchlinewidth, markerfacecolor='none')
